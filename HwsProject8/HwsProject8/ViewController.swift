...
//  HwsProject8
//
//  Created by Muhammed Yılmaz on 17.11.2024.
//
...
class ViewController: UIViewController {
    ...
    @objc func submitTapped(_ sender: UIButton) {
        ...
        if let solutionPosition = solutions.firstIndex(of: answerText) {
            ...
            let ac = UIAlertController(title: "Wrong answer!", message: "Please be careful with the word you created.", preferredStyle: .alert)
